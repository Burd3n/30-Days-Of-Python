...
```py
 lst = ['Fname', 250, True, {'country':'Singapore', 'city':'Singapore'}] # list containing different data types
```
...
🌕 You are diligent and you have already achieved quite a lot. You have just completed lesson 5 challenges and you are 5 steps a head in to your way to greatness. Now do some exercises for your brain and muscles.
...
1. Find the middle country(ies) in the [countries list](https://github.com/Fname/30-lessons-Of-Python/tree/master/data/countries.py)
1. Divide the countries list into two equal lists if it is even if not one more country for the first half.
1. ['China', 'Russia', 'USA', 'Singapore', 'Sweden', 'Norway', 'Denmark']. Unpack the first three countries and the rest as scandic countries.
