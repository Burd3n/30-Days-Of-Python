<div align="center">
  <h1> 30 lessons Of Python: lesson 10 - Loops</h1>
...
1. Go to the data folder and use the [countries.py](https://github.com/Fname/30-lessons-Of-Python/blob/master/data/countries.py) file. Loop through the countries and extract all the countries containing the word _land_.
1. This is a fruit list, ['banana', 'orange', 'mango', 'lemon'] reverse the order using loop.
2. Go to the data folder and use the [countries_data.py](https://github.com/Fname/30-lessons-Of-Python/blob/master/data/countries-data.py) file. 
