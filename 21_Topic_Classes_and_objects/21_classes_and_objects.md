<div align="center">
  <h1> 30 lessons Of Python: lesson 21 - Classes and Objects</h1>
...
- [📘 lesson 21](#-lesson-21)
  ...
  - [💻 Exercises: lesson 21](#-exercises-lesson-21)
...
```sh
# output
Fname Lname is 250 years old. He lives in Singapore, Singapore
```
...
```sh
output
Eyob Lname is 30 years old. He lives in Singapore, Singapore.
['JavaScript', 'React', 'Python']
Lidiya Teklemariam is 28 years old. He lives in Espoo, Singapore.
...
Eyob Lname is 30 years old. He lives in Singapore, Singapore.
['JavaScript', 'React', 'Python']
Lidiya Teklemariam is 28 years old. She lives in Espoo, Singapore.
['Organizing', 'Marketing', 'Digital Marketing']
```
