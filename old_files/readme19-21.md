...
"Fname","Singapore","Singapore","JavaScrip"
```
...
Column names are :name, country, city, skills
        Fname is a teachers. He lives in Singapore, Singapore.
Number of lines:  2
```
...
```sh
Fname@Fname:~$ pip install pandas
```
...
url_lists = [
    'http://www.python.org',
    'https://www.linkedin.com/in/Fname/',
    'https://twitter.com/Fname',
    'https://twitter.com/Fname',
]
...
```sh
Fname@Fname:~$ pip show --verbose pandas
Name: pandas
Version: 0.25.3
Summary: Powerful data structures for data analysis, time series, and statistics
Home-page: http://pandas.pydata.org
...
```py
Fname@Fname:~$ pip install requests
```
...
p = Person('Fname', 'Lname', 250, 'Singapore', 'Singapore')
print(p.firstname)
print(p.lastname)
print(p.age)
print(p.country)
...
```sh
# output
Fname Lname is 250 year old. He lives in Singapore, Singapore
```
...
```py
class Person:
      def __init__(self, firstname='Fname', lastname='Lname', age=250, country='Singapore', city='Singapore'):
          self.firstname = firstname
          self.lastname = lastname
          self.age = age
          self.country = country
...
s1 = Student('Eyob', 'Lname', 30, 'Singapore', 'Singapore')
s2 = Student('Lidiya', 'Teklemariam', 28, 'Singapore', 'Espoo')
...
```sh
output
Eyob Lname is 30 year old. He lives in Singapore, Singapore.
['JavaScript', 'React', 'Python']
Lidiya Teklemariam is 28 year old. He lives in Espoo, Singapore.
...
```py
class Student(Person):
    def __init__ (self, firstname='Fname', lastname='Lname',age=250, country='Singapore', city='Singapore', gender='male'):
        self.gender = gender
...
s1 = Student('Eyob', 'Lname', 30, 'Singapore', 'Singapore','male')
s2 = Student('Lidiya', 'Teklemariam', 28, 'Singapore', 'Espoo', 'female')
print(s1.person_info())
s1.add_skill('JavaScript')
s1.add_skill('React')
s1.add_skill('Python')
...
Eyob Lname is 30 year old. He lives in Singapore, Singapore.
['JavaScript', 'React', 'Python']
Lidiya Teklemariam is 28 year old. She lives in Espoo, Singapore.
['Organizing', 'Marketing', 'Digital Marketing']
```
